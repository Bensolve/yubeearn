...
export default function Home() {
  ...
  const steps: StepCardProps[] = [
    {
      ...
      description: 'Create account. Choose your role. You&apos;re ready.',
    },
    {
      number: 2,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Navbar */}
      <Navbar loginHref="/login" signupHref="/choose-role" />
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/choose-role">
              <button className="w-full sm:w-auto bg-white text-red-600 px-6 md:px-8 py-4 md:py-5 rounded-lg font-bold text-base md:text-lg hover:bg-gray-100 transition shadow-lg">
                🚀 Get Started Now
              </button>
            </Link>
            <Link href="/login">
              <button className="w-full sm:w-auto bg-transparent border-3 border-white text-white px-6 md:px-8 py-4 md:py-5 rounded-lg font-bold text-base md:text-lg hover:bg-white hover:text-red-600 transition shadow-lg">
